      ...
      <div className="flex">
        <div className="xl:flex flex-col gap-10 mt-20 px-36 py-20 max-w-6xl">
          ...
          <div className="text-2xl">
            ...
            <p>
              Avec son portefeuille diversifié et composé de médicaments de marque distribués tant
              en ville qu’à l’hôpital – dont certains occupent des positions de leader dans leurs
              classes thérapeutiques respectives – Les Laboratoires Ethypharm disposent d’une belle
...
// Signup, login, systeme d'autantification
